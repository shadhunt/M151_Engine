...
def char_sheet_grid_formular(col_ran, row_ran, col_count=4, row_count=2 ):
   return [10 + col * 33 for col in range(col_ran, col_ran + col_count)], [25 + row * 33 for row in range(row_ran, row_ran + row_count)]
...
MISSILE_COL_X, MISSILE_ROW_Y = char_sheet_grid_formular(5, 19, 3, 1)
